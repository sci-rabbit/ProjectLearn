...
async def test_handler_cu_with_same_email(setup_db, async_client):
    ...
    new_user_with_same_email = {"name": "kurwa",
                "surname": "bob",
                "email": "clashroyal@gmail.com",
                "password": "fmkfmk223"}
...
@pytest.mark.asyncio
@pytest.mark.parametrize("user_data_for_creation, expected_status_code", [
    ({}, 422),
    ({"name": "mi",
                "surname": "pekka",
                "email": "clashroyal@gmail.com",
...
async def test_validation_error(setup_db, async_client, user_data_for_creation, expected_status_code):
    await setup_db
